#!/bin/bash
#SBATCH --job-name=EXE_EPOCH # Job name
...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_speed_kin/_slurm_logs/%j_mcc_epoch_process.log # Standard output
