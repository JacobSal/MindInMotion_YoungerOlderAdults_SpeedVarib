...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/i_HEADMODEL/1_segmentation/run_headreco_batch-%j.log # Standard output
#SBATCH --account=dferris # Account name
#SBATCH --qos=dferris-b # Quality of service name
#SBATCH --partition=hpg-default # cluster to run on  use slurm command "sinfo -s"
# sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/0_DATA_PREP/3_MRI_PREP/SimNIBS/run_headreco_batch.sh
module purge
