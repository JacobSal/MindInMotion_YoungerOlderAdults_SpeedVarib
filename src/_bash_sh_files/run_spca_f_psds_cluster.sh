...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_oa_speed_eeg_out/_slurm_logs/%j_spca_f_psds_cluster.log # Standard output
...
# Kick off matlab
matlab -nodisplay < $SCRIPT_DIR/spca_f_psds_cluster.m
