...
#                    "gridExtra","genlasso"));
# sbatch /blue/dferris/jsalminen/GitHub/MIND_IN_MOTION_PRJ/MindInMotion_YoungerOlderAdult_KinEEGCorrs/src/r_scripts/sbs_lme_mods/run_tf_flasso_mapply.sh
...
fname_save = "rdata_extc_phasec_notw_nocondb"
...
#-- extract data
# ext_inds = c(1,7,2,4,5,9,8,3,6,10,11)
ext_inds = 1:11;
dato = get_mat_dat(tmp_mat,ext_inds);
indexl <- dato$indexl;
