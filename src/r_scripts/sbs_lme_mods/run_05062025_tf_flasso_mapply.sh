#!/bin/bash
#SBATCH --job-name=MAPPLY_FLASSO # Job name
#SBATCH --mail-type=ALL # Mail events (NONE, BEGIN, END, FAIL, ALL)
#SBATCH --mail-user=jsalminen@ufl.edu # Where to send mail
#SBATCH --nodes=1 # Number of nodes
#SBATCH --ntasks=1 # Number of MPI ranks
#SBATCH --cpus-per-task=86 # Number of tasks on each node
...
# sbatch /blue/dferris/jsalminen/GitHub/MIND_IN_MOTION_PRJ/MindInMotion_YoungerOlderAdult_KinEEGCorrs/src/r_scripts/sbs_lme_mods/run_05062025_tf_flasso_mapply.sh
...
# Kick off R
Rscript $SCRIPT_DIR/05062025_tf_flasso_mapply.R
