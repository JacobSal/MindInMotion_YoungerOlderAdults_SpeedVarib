...
# sbatch /blue/dferris/jsalminen/GitHub/MIND_IN_MOTION_PRJ/MindInMotion_YoungerOlderAdult_KinEEGCorrs/src/r_scripts/sbs_lme_mods/run_tf_flasso_lmer_stat_speed.sh
...
# Kick off R
Rscript $SCRIPT_DIR/tf_flasso_lmer_stat_speed.R
