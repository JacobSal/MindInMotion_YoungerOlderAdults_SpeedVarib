...
#                     "**THETA** QCVi","**ALPHA** QCVi","**BETA** QCVi",
#                     "**THETA** COVc","**ALPHA** COVc","**BETA** COVc",
...
#%% LOADING PARAMETERS
# fext = "new_slidingb36";
# fext = 'allcond_perstridefb_nfslidingb3';
...
#                  'cov_mu_avg_theta','cov_mu_avg_beta','cov_mu_avg_alpha',
#                  'cov_avg_theta_fn1','cov_avg_beta_fn1','cov_avg_alpha_fn1',
#                  'cov_avg_theta_calc_fn1','cov_avg_beta_calc_fn1','cov_avg_alpha_calc_fn1',
#                       'mu_avg_theta_fn1','mu_avg_beta_fn1','mu_avg_alpha_fn1');
# eeg_title_chars = c("**THETA** STD","**BETA** STD","**ALPHA** STD",
#                     "**THETA** COVi","**BETA** COVi","**ALPHA** COVi",
#                     "**THETA** COV","**BETA** COV","**ALPHA** COV",
#                     "**THETA** COVr","**BETA** COVf","**ALPHA** COVr",
#                     "**THETA** COVc","**BETA** COVc","**ALPHA** COVc",
#                       "**THETA** Mean","**BETA** Mean","**ALPHA** Mean");
eeg_measures = c('std_avg_theta_fn1','std_avg_beta_fn1','std_avg_alpha_fn1',
                 'cov_i_avg_theta_fn1','cov_i_avg_beta_fn1','cov_i_avg_alpha_fn1',
                  'mu_avg_theta_fn1','mu_avg_beta_fn1','mu_avg_alpha_fn1');
...
write.xlsx(dtbl,paste0("03122025_lme_eeg_kin_",fext,"_tbl.xlsx"))
```
