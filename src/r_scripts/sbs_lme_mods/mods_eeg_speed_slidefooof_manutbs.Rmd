...
# eeg_title_chars = c("SD\\(/U+03B8\\)","SD\\(/U+03B2\\)","SD\\(/U+03B1\\)",
#                     "COV\\(/U+03B8<sub>i</sub>\\)","COV\\(/U+03B8<sub>i</sub>\\)","COV\\(/U+03B8<sub>i</sub>\\)",
#                       "\\</U+03B8\\>","\\</U+03B2\\>","\\</U+03B1\\>")
eeg_title_chars = c("SD(\\U+03B8)","SD(\\U+03B2)","SD(\\U+03B1)",
                    "COV(\\U+03B8 i)","COV(\\U+03B8 i)","COV(\\U+03B8 i)",
                      "<\\U+03B8>","<\\U+03B2>","<\\U+03B1>")
# eeg_title_chars = c("SD\\(**$\\theta$**\\)","SD\\(**$\\beta$**\\)","SD\\(**$\\alpha$**\\)",
#                     "COV\\(**$\\theta$**<sub>i</sub>\\)","COV\\(**$\\beta$**<sub>i</sub>\\)","COV\\(**$\\alpha$**<sub>i</sub>\\)",
#                       "\\<**$\\theta$**\\>","\\<**$\\beta$**\\>","\\<**$\\alpha$**\\>")
# eeg_title_chars = c("SD\\(**:theta:**\\)","SD\\(**:beta:**\\)","SD\\(**:alpha:**\\)",
                    # "COV\\(**:theta:**<sub>i</sub>\\)","COV\\(**:beta:**<sub>i</sub>\\)","COV\\(**:alpha:**<sub>i</sub>\\)",
                    #   "\\<**:theta:**\\>","\\<**:beta:**\\>","\\<**:alpha:**\\>")
#theta uncode: U+03B8
...
dtbl <- mutate(dtbl,across(c('group_n'), factor))
...
dtbl$speed_cond_num <- as.numeric8(dtbl$speed_n);
...
write.xlsx(excel_df,paste0("lme_eeg_kin_",fext,"_stats.xlsx"))
```
