...
eeg_title_chars = c("**BETA** Mean","**ALPHA** Mean","**BETA** Mean");
```
...
excel_dir <- "/jsalminen/GitHub/MIND_IN_MOTION_PRJ/_data/MIM_dataset/_studies/01192025_mim_yaoa_nopowpow_crit_speed/__iclabel_cluster_kmeansalt_rb3/icrej_5/11/kin_eeg_step_to_step/sbs_eeg_psd_meandesignb_nfslidingb5.xlsx"
...
kin_measures = c('mu_ml_exc_mm_gc_fn2','mu_step_dur_fn2','mu_stance_dur_fn2');
kin_title_chars = c("ml exc. Std Dev.","step dur. Std Dev.","stance dur. Std Dev.")

#%% EEG PARAMS
#-- EEG PARAMS (fn1 = mean, fn2 = sd)
eeg_measures = c('cov_avg_theta_post','cov_avg_beta_post','cov_avg_alpha_post',
                     'mu_avg_theta_fn2','mu_avg_beta_fn2','mu_avg_alpha_fn2');
eeg_title_chars = c("**THETA** COV","**BETA** COV","**ALPHA** COV",
...
write.xlsx(dtbl,"01302025_lme_eeg_kin_meansd_slidingmeanb5_tbl.xlsx")
```
...
write.xlsx(excel_df,"013022025_lme_eeg_kin_meansd_slidingavgb5.xlsx")
```
