...
#--
convert_dos_to_unix_path <- function(dos_path) {
  unix_path <- gsub("\\\\", "/", dos_path)
  return(unix_path)
}
#--
ispc <- function() {
...
excel_dir <-"/jsalminen/GitHub/par_EEGProcessing/src/_data/MIM_dataset/_studies/10172024_MIM_YAOAN89_antsnorm_dipfix_iccREMG0p4_powpow0p3_skull0p01_15mmrej_speed/__iclabel_cluster_kmeansalt_rb5/icrej_5/11/step_by_step_eeg_psd_prepost_imufix_table.xlsx"
...
kin_title_chars = c("step width (m)","ap exc. (m)","step width GC (m)","ap exc. GC(m)") 
