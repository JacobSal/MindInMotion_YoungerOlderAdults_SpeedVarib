...
% KINNAMES_LABS = {'Step Width (m)','AP Excursion (m)','Step Width (m)','AP Excursion (m)'};
%-
% KINNAMES = {'step_width_mm_gc','ap_exc_mm_gc'};
...
%- (01/16/2023) __iclabel_kmeansalt_rb10
...
%     'Left Posterior Parietal',...
%     'Left Supplementary Motor','Right Temporal'};
cluster_titles = {'','','Left Temporal','Right Sensorimotor','Left Occipital','Left Supplementary Motor',...
                ...
                if anova_p_intact < ALPHA
                    ...
                    if DO_PLOT_R2
                        ...
                        if ~isempty(chkl) & cond_i == 1
                            ...
                            str = sprintf('%s R^2=%0.2g\ny_{0.25}=(%0.2g)x+(%0.2g)\ny_{1.0}=(%0.2g)x+(%0.2g)',ast,R2,m_25,b_25,m_1,b_1);
