...
EEG_MEASURE_LABS = {'Mean 10*log_{10}(PSD_{N})','Std. Dev. 10*log_{10}(PSD_{N})', ...
    'Mean 10*log_{10}(PSD_{N})','Std. Dev. 10*log_{10}(PSD_{N})', ...
    'Mean 10*log_{10}(PSD_{N})','Std. Dev. 10*log_{10}(PSD_{N})'};
EEG_MEASURE_TITLES = {'Sliding Means \theta','Sliding Variations \theta', ...
    'Sliding Means \alpha','Sliding Variations \alpha', ...
    'Sliding Means \beta','Sliding Variations \beta'};
...
PLOT_STRUCT = struct('color_map',cmaps_speed,...
    ...
    'ax_line_width',1,...
    'xtick_angle',75);
VIOLIN_STRUCT = struct('Width',0.075,...
    'ShowWhiskers',false,...
    'ShowNotches',false,...
    'ShowBox',true,...
    'ShowMedian',true,...
...
EEG_MEASURES = {'std_avg_theta_fn1', ...
    'std_avg_alpha_fn1', ...
    'std_avg_beta_fn1'};
EEG_MEASURE_LABS = {'Mean 10*log_{10}(PSD_{N})', ...
    'Mean 10*log_{10}(PSD_{N})', ...
    'Mean 10*log_{10}(PSD_{N})'};
EEG_MEASURE_TITLES = {'Sliding Means \theta', ...
    'Sliding Means \alpha', ...
    'Sliding Means \beta'};
...
for c_i = 1:length(clusters)
    ...
    hold off;
    %##
    exportgraphics(fig,[tmp_savedir filesep sprintf('cl%s_eegspeed_plot_group.tiff',string(clusters(c_i)))],...
        'Resolution',300)
    % close(fig)
end