#!/bin/bash
#SBATCH --job-name=DD_EEG_LS_STS_ANL # Job name
...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_speed_kin/_slurm_logs/%j_dd_eeg_ls_sts_anl.log # Standard output
#SBATCH --account=dferris # Account name
#SBATCH --qos=dferris-b # Quality of service name
#SBATCH --partition=hpg-default # cluster to run on, use slurm command 'sinfo -s'
# sbatch /blue/dferris/jsalminen/GitHub/par_EEGProcessing/src/2_STUDY/mim_yaoa_speed_kin/step_to_step_anlz/run_dd_eeg_ls_sts_anl.sh
...
# Kick off matlab
matlab -nodisplay < $SCRIPT_DIR/dd_eeg_ls_sts_anl.m
