#!/bin/bash
#SBATCH --job-name=ANTS_MRI_NORM_PT2 # Job name
...
#%% sbatch /blue/dferris/jsalminen/GitHub/MIND_IN_MOTION_PRJ/MindInMotion_YoungerOlderAdult_KinEEGCorrs/src/prep_scripts/f_ants_apply_trans.bash
...
do
	...
	export dip_csv="$SUBJ_EEG/$s/head_model/dip_pos.csv"
	export dip_csv_outf="$SUBJ_EEG/$s/head_model/dip_pos_outf.csv"
