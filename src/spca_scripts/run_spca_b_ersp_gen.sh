#!/bin/bash
#SBATCH --job-name=SPCA_B_TW_TF # Job name
...
#SBATCH --output=/blue/dferris/jsalminen/GitHub/MIND_IN_MOTION_PRJ/MindInMotion_YoungerOlderAdult_KinEEGCorrs/src/_slurm_logs/%j_spca_b_ersp_gen.log # Standard output
...
# Kick off matlab
matlab -nodisplay < $SCRIPT_DIR/spca_b_ersp_gen.m
