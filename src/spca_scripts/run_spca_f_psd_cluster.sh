#!/bin/bash
#SBATCH --job-name=SPCA_F_CLUSTER_PSD # Job name
...
#SBATCH --output=//blue/dferris/jsalminen/GitHub/MIND_IN_MOTION_PRJ/MindInMotion_YoungerOlderAdult_KinEEGCorrs/src/_slurm_logs/%j_spca_f_psd_cluster.log # Standard output
...
# Kick off matlab
matlab -nodisplay < $SCRIPT_DIR/spca_f_psd_cluster.m
